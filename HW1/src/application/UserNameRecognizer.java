	...
	public String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//	1: a A-Z, a-z, 0-9, "-", "_", that transitions back to state 1
				//  2: a period, underscore, or dash that transitions to state 2 

				
				// A-Z, a-z, 0-9, "-", "_" -> State 1
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||	// Check for A-Z
					(currentChar >= 'a' && currentChar <= 'z' ) ||	// Check for a-z
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '-' || currentChar == '_') {// Check for special character 
					nextState = 2;
			...
			case 2: 
				// State 2 deals with a character after a period, underscore, or dash in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, underscore, or dash must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
