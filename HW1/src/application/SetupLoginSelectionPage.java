...
public class SetupLoginSelectionPage {
    ...
    public SetupLoginSelectionPage(DatabaseHelper databaseHelper, UserNameRecognizer userRecognizer, PasswordEvaluator passRecognizer) {
    ...
    public void show(Stage primaryStage) {
        ...
        setupButton.setOnAction(a -> {
            new SetupAccountPage(databaseHelper, userRecognizer, passRecognizer).show(primaryStage);
        });
